...
function ActionMap(actionmap, color)
{
  ...
  this.AddAction = function(nickname, abbreviation, fullname, inputType, bindings)
  {
    actionList.push( { "nickname":     nickname     ,
